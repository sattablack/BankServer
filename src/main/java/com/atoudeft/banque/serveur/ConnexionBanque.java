...
public class ConnexionBanque extends Connexion {
    ...
    public boolean estInactifDepuis(long delai) {
        //Je verifie si l'heure actuelle du systeme est superieur au temps de la derniere operation + le delai
        return System.currentTimeMillis() > this.tempsDerniereOperation + delai;
    }
